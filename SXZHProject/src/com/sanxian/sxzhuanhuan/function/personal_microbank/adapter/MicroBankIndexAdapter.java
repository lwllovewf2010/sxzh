package com.sanxian.sxzhuanhuan.function.personal_microbank.adapter;
...
public class MicroBankIndexAdapter extends BaseAdapter {
	private Context context;
	private List<MicroBankBillInfo> list;
	private LayoutInflater mInflater;
	private DisplayImageOptions options;
	protected ImageLoader imageLoader ;

	public MicroBankIndexAdapter(Context context, List<MicroBankBillInfo> comcardsList) {
...
//		.showImageOnFail(R.drawable.default_ico)//加载失败的时候
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Holder holder;
		MicroBankBillInfo entity = list.get(position);
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.microbank_index_lvitem, null);
			   holder = new Holder();
