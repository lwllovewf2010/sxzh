 ...
 */
public class AccountRechargeActivity extends BaseActivity implements IBaseActivity, OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.microbank_account_recharge);
		intImageUtil();
		this.initView();
		this.initListener();
