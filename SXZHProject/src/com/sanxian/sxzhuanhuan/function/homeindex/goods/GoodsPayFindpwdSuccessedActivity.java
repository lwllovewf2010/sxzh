...
*  
*/
public class GoodsPayFindpwdSuccessedActivity extends BaseActivity {
	RelativeLayout pwdSettingSuccessed;
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		pwdSettingSuccessed = (RelativeLayout) getLayoutInflater().inflate(
				R.layout.goods_pay_setting_successed_activity, null);
		setContentView(pwdSettingSuccessed);
	}
