 ...
 * 
 */
public class GoodsPayFindpwd3Activity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findPWDLayout = (RelativeLayout) getLayoutInflater().inflate(
				R.layout.goods_pay_findpwd3_activity, null);
	...
	public void dellwithbuttons(View view) {
		...
		switch (id) {
		case R.id.goods_pay_findpwd3_next:
			goodsPayFindpwd3Next(view);
			break;
		case R.id.goods_pay_findpwd3_back:
			finish();
			break;
	...
	public void goodsPayFindpwd3Next(View view) {
		Intent intent = new Intent(this, GoodsPayFindpwd3SucceedActivity.class);
