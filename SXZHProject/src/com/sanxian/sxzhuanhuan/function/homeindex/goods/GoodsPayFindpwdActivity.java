 ...
 * 
 */
public class GoodsPayFindpwdActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findPWDLayout = (RelativeLayout) getLayoutInflater().inflate(
				R.layout.goods_pay_findpwd_activity, null);
	...
	public void dellwithbuttons(View view) {
		...
		switch (id) {
		case R.id.goods_pay_findpwd_next:
			goodsPayFindpwdNext(view);
			break;
		case R.id.goods_pay_findpwd_back:
			finish();
			break;
	...
	public void goodsPayFindpwdNext(View view) {
		Intent intent = new Intent(this, GoodsPayFindpwd2Activity.class);
