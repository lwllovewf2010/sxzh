...
public class ScUtil {
	...
	// ViewPager是google SDk中自带的一个附加包的一个类，可以用来实现屏幕间的切换。
				...
				private void InitTextView(String text1Name,String text2Name) {
					t1 = (TextView) content.findViewById(R.id.topic_content_miaos);
					t2 = (TextView) content.findViewById(R.id.topic_content_comment);
				...
				private void InitImageView() {
					...
					bmpW = BitmapFactory.decodeResource(content.getResources(), R.drawable.a)
							.getWidth();// 获取图片宽度
