 ...
 * @version V1.0
 */
public class PubVoteActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pub_vote);
...
//		btnPub.setOnClickListener(this) ;
	...
	public void onClick(View v) {
		...
		case R.id.pub_vote_btn:
			Util.toastInfo(PubVoteActivity.this, "-------") ;
			break;
		}
	}
