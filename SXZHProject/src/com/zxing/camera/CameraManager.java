...
public final class CameraManager {
	...
	private static final int SUPER_MAX_FRAME_WIDTH = 720;
	private static final int SUPER_MAX_FRAME_HEIGHT = 720;
...
//				height = MIN_FRAME_HEIGHT;
//			} 
			else if (width >= MAX_FRAME_WIDTH && width < SUPER_MAX_FRAME_WIDTH) {
				width = MAX_FRAME_WIDTH;
				height = MAX_FRAME_HEIGHT;
			} else {
				width = SUPER_MAX_FRAME_WIDTH;
				height = SUPER_MAX_FRAME_HEIGHT;
			}
			width=width*3/4;
			height=height*3/4;
			...
			// height = MIN_FRAME_HEIGHT;
			// } else if (height >
			// MAX_FRAME_HEIGHT&&height<SUPER_MAX_FRAME_HEIGHT) {
			// height = MAX_FRAME_HEIGHT;
			// }else {
			// height = SUPER_MAX_FRAME_HEIGHT;
			// }
			// height=height*3/4;//honaf临时添加
