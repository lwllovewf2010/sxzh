            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                if (elementName.equals("subject")) {
                    ...
                    if (message.getContentType() == null) {
                        ...
                        Log.d("test", "解析到contenttype时候的值"+contentType);
                        message.setContentType(contentType);
                    }
                }
                else if (elementName.equals("sendUserName")) {
                    if (message.getSendUserName() == null) {
                    	message.setSendUserName(parser.nextText());
                    }
                }else if (elementName.equals("vocieLength")) {
                    if (message.getVocieLength() == null) {
                    	message.setVocieLength(parser.nextText());
                    }
                }else if (elementName.equals("avatar")) {
                    if (message.getAvatar() == null) {
                    	message.setAvatar(parser.nextText());
                    }
                }
