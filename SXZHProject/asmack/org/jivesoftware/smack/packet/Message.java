...
public class Message extends Packet {
	...
	public String getVocieLength() {
		return vocieLength;
	}

	public void setVocieLength(String vocieLength) {
		this.vocieLength = vocieLength;
	}
    ...
    public String toXML() {
        ...
        if (contentType != null) {
        	buf.append("<contentType>").append(contentType).append("</contentType>");
        }
        if (vocieLength != null) {
        	buf.append("<vocieLength>").append(vocieLength).append("</vocieLength>");
        }
